 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Dev4U:Панель управления | Laravel 5</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('admin/users') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/users') }}"><i class="fa fa-user-o"></i> Пользователи</a>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li {{ (Request::is('admin/sliders') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/sliders') }}"><i class="fa fa-file-image-o" aria-hidden="true"></i> Слайдер</a>
                        </li>
                        <li {{ (Request::is('admin/topLink') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/topLink') }}"><i class="fa fa-th-large" aria-hidden="true"></i> Блоки-ссылки</a>
                        </li>
                        <li {{ (Request::is('admin/gallery') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/gallery') }}"><i class="fa fa-file-image-o" aria-hidden="true"></i> Галлерея</a>
                        </li>
                        <li {{ (Request::is('admin/trainers') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/trainers') }}"><i class="fa fa-users" aria-hidden="true"></i> Тренеры</a>
                        </li>
                        <li {{ (Request::is('admin/programs') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/programs') }}"><i class="fa-file-text-o" aria-hidden="true"></i> Программы</a>
                        </li>
